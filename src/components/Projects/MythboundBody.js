    ...
    <>
      <div className="project-section accomplishments">
        ...
        <div className="accomplishment-group">
          <h3>Combat</h3>
          <p>I was responsible for implementing the core combat systems, including the damage calculation and combo attack mechanics. This involved creating a robust framework for handling combat interactions.</p>
          <ul>
            <li><strong>Hitboxes:</strong> Dynamic, resizable hitboxes for each character and each combo attack</li>
          ...
          <ZoomableImage 
            src={`${process.env.PUBLIC_URL}/images/portfolio/Mythbound/MythboundHitboxes.webp`}
            alt="Mythbound Character Data"
            caption="Combo attack for Alvar's combo"
          />
        </div>
        ...
        <div className="accomplishment-group two-column">
          ...
          <ZoomableImage 
            src={`${process.env.PUBLIC_URL}/images/portfolio/Mythbound/MythboundSpineRotation.mp4`}
            alt="Mythbound Character Data"
          />
        </div>
      </div>
